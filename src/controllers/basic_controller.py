...
class BasicMAC:
    ...
    def init_hidden(self, batch_size):
        self.hidden_states_ind = self.agent_ind.init_hidden().unsqueeze(0).expand(batch_size, self.n_agents - 6, -1)
        self.hidden_states_pairs = self.agent_pairs.init_hidden().unsqueeze(0).expand(batch_size, 3, -1)
    ...
    def _build_inputs(self, batch, t):
        ...
        inputs_ind = inputs[:, :self.n_agents - 6, :]
        inputs_pairs = inputs[:, self.n_agents - 6:, :]
